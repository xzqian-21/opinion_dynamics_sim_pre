...
% main_fig4_d.m
%
% This script generates Fig.4(d) for article:
%
...
%% ------------------------------------------------------------------------
%  Simulation: collect spectra before and after node removal
% -------------------------------------------------------------------------
...
save('./result/sp_str_100.mat', ...
     'rec_sp_new', 'rec_sp_old', 'n_total', 'N');
...
height1 = movmean(counts_new, 4) * ratio;  
height2 = movmean(counts_old, 4);          
